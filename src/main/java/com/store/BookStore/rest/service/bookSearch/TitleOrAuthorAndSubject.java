...
public class TitleOrAuthorAndSubject implements SearchService {
    private final BookRepository bookRepository;
    @Autowired
    public TitleOrAuthorAndSubject(BookRepository bookRepository) {
        this.bookRepository = bookRepository;
    }
    public List<Book> findBooksByParams(String title, String author, String subject){
        return bookRepository.findBooksByTitleOrAuthorAndSubject(title, author, subject);
    }
}
